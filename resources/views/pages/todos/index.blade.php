<?php
	// メタデータ、ヘルパ関数をロードする
	require base_path('resources/views/theme.php');

	// ページ固有のメタデータを追加する
	$metadata->page_title = 'TODOリスト';
	$metadata->page_description = 'Laravel 5.1で作るWebアプリケーションのサンプルです。';
	$metadata->page_url = 'http://laravel5.samples.jumilla.me/todos';
?>
{{-- 解説: レイアウトを指定しています。--}}
